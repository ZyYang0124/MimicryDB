...
export type GbifMatch={input:string;queriedAs:string|null;matchType:string;confidence?:number|null;gbif_usageKey?:number|null;gbif_canonical?:string|null;gbif_rank?:string|null;gbif_kingdom?:string|null;warning?:string|null;note?:string};
